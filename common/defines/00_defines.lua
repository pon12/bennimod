...
NDiplomacy = {
	...
	EMBARGO_COST = 999,										-- One-time cost
	REVOKE_EMBARGO_COST = 0,								-- Cost to remove an existing embargo
	EMBARGO_THREAT_THRESHOLD = 99,						-- Target-generated threat threshold to allow embargo (affected by modifiers)
